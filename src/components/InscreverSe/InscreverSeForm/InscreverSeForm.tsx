            ...
            >
                <Form onChange={() => setBlock(false)} className={"w-1/3"}>
                    ...
                    <div className={"flex justify-center"}>
                        <Button disabled={block} type={"submit"} className={`flex items-center justify-center w-48 h-10 hover:${block ? "none" : "scale-105"} drop-shadow-md transition gap-2 bg-gray-700 text-gray-200 font-sans font-normal`}>
                            <EnviarIcon />
                            Enviar Inscrição
                        </Button>
                    </div>
