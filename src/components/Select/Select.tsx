...
export default ({label, name, id, placeholder, options, ...rest}: ISelectProps) => {
  ...
  return(
    <div className="flex flex-col p-5 w-full">
      <Field as="select" className="w-full text-xs p-1 bg-transparent outline-0	text-white placeholder-white border-b border-b-gray-400" id={id} name={name} placeholder={placeholder} {...rest}>
        {
