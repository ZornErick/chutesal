...
export default ({label, name, id, placeholder, className, removeFooter, containerWidth, footerText, ...rest}: IInputProps) => {

  return(
    <div className={`flex flex-col p-5 ${containerWidth ? containerWidth  : 'w-full'}`}>
      {
