...
import {ICampeonato, IMenuElement} from "../../../pages/GerenciarCampeonato/GerenciarCampeonato";
import Modal from "../../Modal/Modal";
import {useState} from "react";
import apiInstance from "../../../services/apit";
import {toast} from "react-toastify";
import {convertToDate} from "../../../helpers/date";
import {IData} from "../../../pages/Campeonatos/Campeonatos";
        ...
        <>
            ...
            <nav className={"flex flex-col items-center gap-10 h-full"}>
                ...
                <div className={"flex flex-col gap-10"}>
                    ...
                    <Button
                        className={"flex justify-around items-center w-28 transition duration-150 hover:scale-105 drop-shadow-md bg-gray-700 text-gray-200 text-lg font-normal font-sans "}
